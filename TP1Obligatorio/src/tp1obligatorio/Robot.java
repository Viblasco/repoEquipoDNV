...
public void avanzar(int cantidad) {
     ...
     if (dormido){
         ...
         if ((cantidad/10) >= energiaActual()){
             ...
             System.out.println("Avanzo "+cantidad+" pasos y gasto "+cantidad*10/100+" "
                     + "le queda "+energiaGastada+ " de carga"  );
                     bateria.setCarga((int) (energiaActual()- (cantidad/10)));
             }
     }
    ...
    public void retroceder(int cantidad) {
     ...
     if (dormido){
         ...
         if ((cantidad/10) >= energiaActual()){
             ...
             System.out.println("Retrocedio "+cantidad+" pasos y gasto "+cantidad*10/100+" "
                     + "le queda "+energiaGastada+ " de carga"  );
                     bateria.setCarga((int) (energiaActual()- (cantidad*10/100)));
             }
     }
